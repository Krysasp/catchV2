...
class Genome:
    ...
    def break_into_fragments(self, fragment_length, include_full_end=False):
        ...
        original_header = getattr(self, 'header', None)
        ...
        frag_genome = Genome.from_chrs(fragment_chrs)
        if original_header:
            frag_genome.header = original_header
        return frag_genome
    ...
    @staticmethod
    def from_one_seq(seq, header=None):
        ...
        Args:
            ...
            header: optional FASTA header for the sequence
